package com.testautomation.github.steps;
...
import com.testautomation.github.pages.LoginPage;
...
public class LoginSteps {
    ...
    public void userIsOnLoginPage() {
        ...
        if (apiKey == null || apiKey.isBlank()) {
            log.error("Missing OpenAI API key! Set 'OPENAI_API_KEY' on Env variables");
